...
<div id="container">
  ...
  <div id="details">
    ...
    <form method="post" action="<?=$this->url->current;?>" enctype="multipart/form-data" id="country_edit_add">
      ...
      <input type="hidden" name="group[user_country_group_id]" value="<?=(isset($data['group']['user_nationality_group_id']) && $data['group']['user_nationality_group_id'] != '' ? $data['group']['user_nationality_group_id'] : '');?>">
            ...
            <div class="header">
              ...
              <div class="add_edit_languages">
                ...
                <?php foreach($data['languages'] as $language): ?>
                    ...
                    <a class="no_underline" href="<?=SITE_URL . LANG_CODE;?>/admin/<?=CONTROLLER?>/edit/<?=$data['group']['user_nationality_group_id']?>/1">
      ...
      <div class="column">
        ...
        <div class="subcolumn">
          ...
          <table>
            ...
            <tr>
              <th>Group name</th>
              <td><input type="text" name="group[user_nationality_group_name]" value="<?=(isset($data['group']['user_nationality_group_name']) ? $data['group']['user_nationality_group_name'] : '');?>"></td>
            </tr>
