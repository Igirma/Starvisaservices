...
<div id="container">
  ...
  <div id="details">
    ...
    <form method="post" action="<?=$this->url->current;?>" enctype="multipart/form-data" id="projects_edit_add">
      ...
      <input type="hidden" name="video[video_id]" value="<?=(isset($data['video']['video_id']) && $data['video']['video_id'] != '' ? $data['video']['video_id'] : '');?>">
      ...
      <div class="column">
        ...
        <?php if($this->url->segment(2) == 'edit'){ ?>
            ...
            <div class="header">
              <input type="hidden" name="video[language][code]" value="<?=$data['video']['language']['code']?>" />
              <div style="position: absolute; left: 11px; top: 15px;" class="language sprite_<?=$data['video']['language']['code']?>"></div>
              ...
              <div class="add_edit_languages">
                ...
                <?php foreach($data['languages'] as $language) { ?>
                    ...
                    <a class="no_underline" href="<?=SITE_URL . LANG_CODE;?>/admin/<?=CONTROLLER?>/edit/<?=$data['video']['video_id']?>/<?=$language['language_id'];?>">
      ...
      <div class="column">
        ...
        <div class="subheader">
          ...
          <h2><?=$this->lang->line('video_info');?></h2>
        ...
        <div class="subcolumn">
          ...
          <table>
            ...
            <tr>
              ...
              <td><input type="text" name="video[title]" value="<?=(isset($data['video']['title']) ? $data['video']['title'] : '');?>"></td>
            </tr>
            
            <tr>
              <th><?=$this->lang->line('sub_active');?></th>
              <td>
                <?php if(isset($data['video']['sub_active'])){ ?>
                
                  <?php if($data['video']['sub_active'] == 1){ ?>
                  
                    <input type="radio" name="video[sub_active]" value="1" checked="checked"><?=$this->lang->line('yes')?>
                    <input type="radio" name="video[sub_active]" value="0"><?=$this->lang->line('no')?>
                  
                  <?php } else { ?>
                  
                    <input type="radio" name="video[sub_active]" value="1"><?=$this->lang->line('yes')?>
                    <input type="radio" name="video[sub_active]" value="0" checked="checked"><?=$this->lang->line('no')?>
            ...
            <tr class="hidden">
              ...
              <td><textarea class="count[120]" name="video[description]"><?=(isset($data['video']['description']) ? $data['video']['description'] : '');?></textarea></td>
            </tr>
            
            <tr>
              <th>URL<br><small>(Youtube, Vimeo)</small></th>
              <td><input type="text" name="video[url]" value="<?=(isset($data['video']['url']) ? $data['video']['url'] : '');?>"></td>
            </tr>
            
            <tr class="hidden">
              <th><?=$this->lang->line('slug');?></th>
              <td><input type="text" name="video[slug]" value="<?=(isset($data['video']['slug']) ? $data['video']['slug'] : '');?>"></td>
            </tr>
      ...
      <a id="anchor_media"></a>
        ...
        <div class="subcolumn">
          ...
          <?php if(!empty($data['video']['media'])): ?>
          
            <?php $x = 0; ?>
            <?php foreach($data['video']['media'] as $media): ?>
              <div class="thumb">
              
                <a href="<?=SITE_URL . LANG_CODE . '/admin/fetch_media_ajax/' . CONTROLLER . '/' . $media['media_id'] . '/' . $data['video']['language_id'];?>" class="modal_ajax" title="<?=$media['filename'];?>"><img src="<?=SITE_URL . ELEM_DIR . 'media/' . CONTROLLER . '/thumb/' . $media['filename'];?>?<?=rand(0, 10100);?>" alt="<?=$media['alt'];?>"></a>
                ...
                <div class="order_media">
                  ...
                  <a class="order_media" href="<?=SITE_URL;?>admin/<?=CONTROLLER?>/order_media/left/<?=$media['table_id'];?>/<?=$data['video']['language_id'];?>/<?=$media['order']?>" title="Move left"><img src="<?=SITE_URL . ELEM_DIR;?>img_admin/left.png"></a>
                  <a class="order_media" href="<?=SITE_URL;?>admin/<?=CONTROLLER?>/order_media/right/<?=$media['table_id'];?>/<?=$data['video']['language_id'];?>/<?=$media['order']?>" title="Move right"><img src="<?=SITE_URL . ELEM_DIR;?>img_admin/right.png"></a>
                ...
                <div class="edit_image">
                  ...
                  <a href="<?=SITE_URL . LANG_CODE . '/admin/fetch_media_ajax/' . CONTROLLER . '/' . $media['media_id'] . '/' . $data['video']['language_id'];?>" class="modal_ajax" title="<?=$media['filename'];?>"><?=$this->lang->line('edit_image');?></a>
...
<script type="text/javascript">
  MIN_IMG_W = <?=VIDEOS_CROP_MAX_W;?>;
  MIN_IMG_H = <?=VIDEOS_CROP_MAX_H;?>;
</script>
