				...
				<div class="subcolumn">
					...
					<table>
						...
						<tr>
							...
							<td><input type="text" name="order[payment_type]" value="<?=((isset($data['order']['payment_type']) && isset($data['payment_type']) && isset($data['payment_type'][$data['order']['payment_type']])) ? $data['payment_type'][$data['order']['payment_type']] : '');?>"></td>
						</tr>
						...
						<tr>
							...
							<td><input disabled type="text" name="order[discount_code]" value="<?=(isset($data['order']['discount_code']) ? $data['order']['discount_code'] : '');?>"></td>
						</tr>
						<tr>
							<th><?=$this->lang->line('discount_code_percent');?></th>
							<td><input disabled type="text" name="order[discount_code_percent]" value="<?=(isset($data['order']['discount_code_percent']) ? $data['order']['discount_code_percent'] : '');?>"></td>
						</tr>
						<tr>
							<th><?=$this->lang->line('discount_code_price');?></th>
							<td><input disabled type="text" name="order[discount_code_price]" value="<?=(isset($data['order']['discount_code_price']) ? $data['order']['discount_code_price'] : '');?>"></td>
						</tr>
						<tr>
							<th><?=$this->lang->line('vat_costs');?></th>
							<td><input type="text" name="order[vat_costs]" value="<?=(isset($data['order']['vat_costs']) ? $data['order']['vat_costs'] : '');?>"></td>
						</tr>
						<tr>
