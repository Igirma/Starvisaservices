...
abstract class BaseFacebook
{
   ...
   *
   * @param array $fb_config The application configuration
   */
  public function __construct($fb_config) {
    $this->setAppId($fb_config['appId']);
    $this->setAppSecret($fb_config['secret']);
    if (isset($fb_config['fileUpload'])) {
      $this->setFileUploadSupport($fb_config['fileUpload']);
    }
